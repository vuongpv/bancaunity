...
namespace SocketIOClient.Messages
{
    public class EventMessage : Message
    {
			...
			: this()
        {
			...
			JsonSendingEncodedEventMessage sender = new JsonSendingEncodedEventMessage(eventName, jsonObject);
			this.MessageText = sender.ToJsonString();
			//UnityEngine.Debug.LogWarning("new event " + MessageText);
        }
