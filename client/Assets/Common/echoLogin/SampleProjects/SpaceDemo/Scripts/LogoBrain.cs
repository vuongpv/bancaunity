...
public class LogoBrain : EchoComponent 
{
	...
	//--------------------------------------------------------------------------
	public static void TurnOffSubtitle()
	{
...
//    	EchoFXEvent.Blink_echoUV ( egoLogin, new Vector2 ( 0.0f, 0.0f ), new Vector2 ( 1.0f / 8.0f, 0.0f ), 1.0f );
	...
	void Start()
	{
		...
		egoEcho.UVSetMake ( ELC.CELL8, ELC.CELL8, 4, 2 );

		egoLogin		= EchoGameObject.Find ("LoginFront");
		egoLogin.UVSetMake ( ELC.CELL8, ELC.CELL8, 4, 2 );
