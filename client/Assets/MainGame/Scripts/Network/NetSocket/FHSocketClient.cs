...
#endif
						isJoinRoom = true;
						bool result = fhRoomOnlinePlay.Init (evt.RoomName, evt.roomType, evt.routeID, evt.timePlay, evt.timeUpdate, evt.kindPlay, evt.player_Names, evt.player_SIDs, evt.player_locations, evt.taxPercent);
						if (!result) {
