...
namespace FHNetSocket
{
	...
	///		'1::' [path] [query]
	/// </remarks>
    public class M_ConnectMessage : M_Message
	{
		...
		public M_ConnectMessage() : base()
		{
			this.MessageType = SocketIOMessageTypes.Connect;
		}
		public M_ConnectMessage(string endPoint) : this()
		{
			this.Endpoint = endPoint;
		}
		public static M_ConnectMessage Deserialize(string rawMessage)
		{
			M_ConnectMessage msg = new M_ConnectMessage ();
			//  1:: [path] [query]
			//  1::/test?my=param
