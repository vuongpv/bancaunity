...
public partial class Spline : MonoBehaviour
{
	...
	*/
    ...
    public GameObject AddSplineNode(Vector3 position)
    {
        ...
        gObject.name = GetNodeName(gameObject.transform.GetChildCount());

        if (nodeMode == Spline.ControlNodeMode.UseChildren)
	...
	public GameObject[] AddSplineNodes(Vector3[] positions)
	{
		GameObject[] gObjects = new GameObject[positions.Length];
		int idx = 0;
    ...
    private string GetNodeName(int num)
    {
        string res = "";
