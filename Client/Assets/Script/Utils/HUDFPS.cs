...
public class HUDFPS : MonoBehaviour
{
	...
	void OnGUI()
	{
		if (!render || FHNetworkManager.Instance == null)
            return;
...
//		Debug.Log(FHNetworkManager.Instance.gameServerUrl);
		GUI.color = updateColor ? color : Color.white;
		//startRect = GUI.Window(0, startRect, DoMyWindow, "");
		string networkType = "UNKNOW";
		if(FHNetworkManager.Instance != null)
			networkType = FHNetworkManager.Instance.gameServerUrl;

		GUI.Label(new Rect(10, 40, startRect.width, startRect.height), sFPS + " FPS\nServer "+ networkType);
