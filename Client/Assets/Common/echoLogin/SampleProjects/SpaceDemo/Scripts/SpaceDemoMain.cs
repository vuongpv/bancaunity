...
public class SpaceDemoMain : MonoBehaviour 
{
	...
	public Transform       	raptorX512M_prefab;
...
//		MissileManager.AllocPool ( 8, raptorX512M_prefab.gameObject );

		// =====
		// get objects we use for effects that have EchoComponent added to them
		// =====
	...
	public void StartDemo()
	{
		...
		_efx = EchoFXEvent.Animate_echoRGBA ( SpaceDemoMain.fadePlate, new Vector4 ( 2,2,2,2 ), new Vector4 ( 0,0,0,0 ), 2.2f );
