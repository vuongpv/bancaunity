...
class SatilliteBrain : EchoComponent
{
	...
	public Material 				shieldMat = null;
	static public EchoGameObject    myego;       

//---------------------------------------------------------------------------
	public static void ShieldsUp()
	{
		EchoFXEvent.ShieldOn_echoShader ( egoShield, 0.6f, 1.1f );
...
//---------------------------------------------------------------------------
	...
	{
		shieldFX1[ishieldhitid] = EchoFXEvent.ShieldHit_echoShader ( egoShield, ishieldhitid, ishootdir, 0.2f, 0.6f, 0.0f );
...
//===========================================================================
	void Start()
	{
		...
		EchoFXEvent.CellAnimate_UVSet ( egoScreens, 0, 12, 0.128f, 0 );
