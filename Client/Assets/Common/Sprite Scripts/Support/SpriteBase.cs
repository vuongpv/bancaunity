...
public class UVAnimation
{
		...
		[HideInInspector]
		public float
				framerate = 15f;					// The rate in frames per second at which to play the animation
		...
		/// </summary>
		[HideInInspector]
		public ANIM_END_ACTION
				onAnimEnd = ANIM_END_ACTION.Do_Nothing;
